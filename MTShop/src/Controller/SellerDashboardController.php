...
final class SellerDashboardController extends AbstractController
{
    ...
    public function index(ProductRepository $productRepository): Response
    {
        ...
        $newProductForm = $this->createFormNamed('product_new', ProductType::class, $newProduct, [
        ...
        foreach ($products as $product) {
            $editProductForms[$product->getId()] = $this->createFormNamed('product_edit_' . $product->getId(), ProductType::class, $product, [
                'action' => $this->generateUrl('app_seller_product_edit', ['id' => $product->getId()]),
                'method' => 'POST',
            ])->createView();
        }
